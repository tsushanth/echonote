...
enum AppConstants {
    ...
    enum StoreKit {
        static let bundleIdentifier = "com.kreativekoala.echonote"

        enum Subscriptions {
            static let weekly = "com.kreativekoala.clearvoice.subscription.weekly"
            static let monthly = "com.kreativekoala.clearvoice.subscription.monthly"
            static let yearly = "com.kreativekoala.clearvoice.subscription.yearly"
            static let lifetime = "com.kreativekoala.clearvoice.subscription.lifetime"
        }

        enum InAppPurchases {
            static let removeAds = "com.kreativekoala.echonote.remove_ads"
        }
