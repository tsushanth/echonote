...
enum PremiumFeature: String, CaseIterable {
    ...
    case vocalLayerSeparation = "vocal_layer" // Beta feature
    ...
    case multilingualTranscription = "multilingual_transcription"
    case transcriptIntelligence = "transcript_intelligence"
    ...
    var displayName: String {
        ...
        case .vocalLayerSeparation:
            return "Vocal Layer Separation (Beta)"
        case .transcription:
        ...
        case .multilingualTranscription:
            return "Multilingual Transcription"
        case .transcriptIntelligence:
            return "AI Transcript Intelligence"
        }
    }
    ...
    var description: String {
        ...
        case .vocalLayerSeparation:
            return "Separate vocals from background (Beta feature)"
        case .transcription:
        ...
        case .multilingualTranscription:
            return "Transcribe in 90+ languages with WhisperKit"
        case .transcriptIntelligence:
            return "Clean up, summarize, and extract action items from transcripts"
        }
    }
...
final class PremiumManager {
    ...
    func hasAccess(to feature: PremiumFeature) -> Bool {
        ...
        case .enhancedAudio, .vocalLayerSeparation, .transcription,
             .multilingualTranscription, .transcriptIntelligence:
            return false
        case .cloudBackup:
            return false
